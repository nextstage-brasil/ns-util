...
class PHPMailer {
    ...
    protected function AddAnAddress($kind, $address, $name = '') {
        if (!preg_match('/^(to|cc|bcc|Reply-To)$/', $kind)) {
            ...
            if ($this->SMTPDebug) {
                //echo $this->Lang('Invalid recipient array') . ': ' . $kind; // Comentei esta linha para a classe não imprimir erros. 
            }
            return false;
        }
        ...
        if (!self::ValidateAddress($address)) {
            ...
            if ($this->SMTPDebug) {
                //echo $this->Lang('invalid_address') . ': ' . $address; // Comentei esta linha para a classe não imprimir erros. 
            }
            return false;
        }
        if ($kind != 'Reply-To') {
    ...
    protected function PostSend() {
        try {
            ...
            if ($this->SMTPDebug) {
                //echo $e->getMessage() . "\n"; // Comentei esta linha para a classe não imprimir erros. 
            }
            return false;
        }
    }
