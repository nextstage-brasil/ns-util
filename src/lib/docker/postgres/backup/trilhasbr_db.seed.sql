...
-- Zerar tabelas
TRUNCATE TABLE public.app RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.app_api_log RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.app_cep RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.app_conhecimento RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.app_conhecimento_comentarios RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.app_conhecimento_view RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.app_endereco RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.app_linktable RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.app_login_attempts RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.app_lt_rel RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.app_mensagem RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.app_mensagem_grupo RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.app_mensagem_grupo_users RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.app_municipio RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.app_pais RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.app_shared RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.app_sistema_funcao RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.app_sistema_log RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.app_status RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.app_texto RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.app_trash RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.app_uf RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.app_uploadfile RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.app_usuario RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.app_usuario_permissao RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.caixa RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.caixa_tipo RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.carrinho RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.evento RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.evento_categoria RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.evento_usuario RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.forma_pgto RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.grade RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.json_table RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.pedido RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.pedido_item RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.price RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.produto RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.produto_tipo RESTART IDENTITY CASCADE;
TRUNCATE TABLE public.webhook RESTART IDENTITY CASCADE;

-- Reinserção de dados

INSERT INTO public.app (extras_app) VALUES('{"app": {"pagarme": ""}, "dev": {"pagarme": "", "comissao": 6}, "linkPublic": "https://trl15590-devp.s3-us-east-2.amazonaws.com/", "preparaPacoteRunning": false}'::jsonb);
INSERT INTO public.app_pais (nome_pais, sigla_pais) VALUES('Brasil', 'BR');

INSERT INTO public.app_uf (id_uf,sigla_uf,id_pais,nome_uf) VALUES
	 (1,'AC',1,'Acre'),
	 (2,'AL',1,'Alagoas'),
	 (3,'AM',1,'Amazonas'),
	 (4,'AP',1,'Amapá'),
	 (5,'BA',1,'Bahia'),
	 (6,'CE',1,'Ceará'),
	 (7,'DF',1,'Distrito Federal'),
	 (8,'ES',1,'Espírito Santo'),
	 (9,'GO',1,'Goiás'),
	 (10,'MA',1,'Maranhão'),
...
INSERT INTO public.app_usuario (id_usuario,nome_usuario,tipo_usuario,perfil_usuario,email_usuario,senha_usuario,data_nascimento_usuario,sexo_usuario,rg_usuario,cpf_usuario,token_altera_senha_usuario,cep_usuario,complemento_cep_usuario,token_validade_usuario,ult_acesso_usuario,status_usuario,data_senha_usuario,taxa_usuario,config_usuario,fot_usuario,config_site_usuario,avatar_usuario,session_time_usuario,banco_usuario,endereco_usuario,pagarme_id_usuario,pagarme_status) VALUES
	 (1,'Developer',2,1,'dev@local','NAO DEFINIDA','1976-07-30','M','','38966147038',NULL,'','',NULL,NULL,1,'2022-04-03',NULL,'{}',true,'{}',NULL,20,'{}','{}',NULL,''),
	 (2,'Artur Robot',6,1,'none','NOT_ENABLED_TO_CREATE',NULL,'M','','',NULL,'','',NULL,NULL,1,'2021-04-03',NULL,'{}',false,'{}',NULL,20,'{}','{}','',''),
	 (3,'Administrador da plataforma',2,2,'admin@local','NAO DEFINIDA',NULL,'M','','','','','',NULL,NULL,1,'2022-04-03',NULL,'{}',true,'{}',NULL,20,'{}','{}',NULL,''),
	 (1000,'Fotografo-00 Teste',2,1,'teste-00@local','NAO DEFINIDA',NULL,'M','','','','','',NULL,NULL,1,'2022-04-03',NULL,'{}',true,'{}',1,60,'{}','{}',NULL,''),
	 (1001,'Fotografo-01 Teste',2,1,'teste-01@local','NAO DEFINIDA',NULL,'M','','','','','',NULL,NULL,1,'2022-04-03',NULL,'{}',true,'{}',1,60,'{}','{}',NULL,''),
	 (1002,'Fotografo-02 Teste',2,1,'teste-02@local','NAO DEFINIDA',NULL,'M','','','','','',NULL,NULL,1,'2022-04-03',NULL,'{}',true,'{}',1,60,'{}','{}',NULL,'');

INSERT INTO public.app_municipio (id_municipio,nome_municipio,id_uf) VALUES
	 (1,'Afonso Cláudio',8),
...
INSERT INTO public.app_sistema_funcao (acao_funcao,grupo_funcao,subgrupo_funcao) VALUES
	 ('LER','FORMAPGTO','FORMAPGTO'),
	 ('EDITAR','APILOG','APILOG'),
	 ('LER','APILOG','APILOG'),
	 ('INSERIR','APP','APP'),
	 ('EDITAR','APP','APP'),
	 ('REMOVER','APP','APP'),
	 ...
	 ('REMOVER','CAIXA','CAIXA'),
	 ('LER','CAIXA','CAIXA'),
	 ('INSERIR','CAIXATIPO','CAIXATIPO'),
	 ('EDITAR','CAIXATIPO','CAIXATIPO'),
	 ('REMOVER','CAIXATIPO','CAIXATIPO'),
	 ('LER','CAIXATIPO','CAIXATIPO'),
	 ('INSERIR','CARRINHO','CARRINHO'),
	 ('EDITAR','CARRINHO','CARRINHO'),
	 ('REMOVER','CARRINHO','CARRINHO'),
	 ('LER','CARRINHO','CARRINHO'),
	 ('INSERIR','CEP','CEP'),
	 ('EDITAR','CEP','CEP'),
	 ('REMOVER','CEP','CEP'),
	 ('LER','CEP','CEP'),
	 ('INSERIR','CONHECIMENTOCOMENTARIOS','CONHECIMENTOCOMENTARIOS'),
	 ('EDITAR','CONHECIMENTOCOMENTARIOS','CONHECIMENTOCOMENTARIOS'),
	 ('REMOVER','CONHECIMENTOCOMENTARIOS','CONHECIMENTOCOMENTARIOS'),
	 ('LER','CONHECIMENTOCOMENTARIOS','CONHECIMENTOCOMENTARIOS'),
	 ('INSERIR','CONHECIMENTO','CONHECIMENTO'),
	 ('EDITAR','CONHECIMENTO','CONHECIMENTO'),
	 ('REMOVER','CONHECIMENTO','CONHECIMENTO'),
	 ('LER','CONHECIMENTO','CONHECIMENTO'),
	 ('INSERIR','CONHECIMENTOVIEW','CONHECIMENTOVIEW'),
	 ('EDITAR','CONHECIMENTOVIEW','CONHECIMENTOVIEW'),
	 ('REMOVER','CONHECIMENTOVIEW','CONHECIMENTOVIEW'),
	 ('LER','CONHECIMENTOVIEW','CONHECIMENTOVIEW'),
	 ('INSERIR','ENDERECO','ENDERECO'),
	 ('EDITAR','ENDERECO','ENDERECO'),
	 ('REMOVER','ENDERECO','ENDERECO'),
	 ('LER','ENDERECO','ENDERECO'),
	 ('INSERIR','EVENTOCATEGORIA','EVENTOCATEGORIA'),
	 ('EDITAR','EVENTOCATEGORIA','EVENTOCATEGORIA'),
	 ('REMOVER','EVENTOCATEGORIA','EVENTOCATEGORIA'),
	 ('LER','EVENTOCATEGORIA','EVENTOCATEGORIA'),
	 ('INSERIR','EVENTO','EVENTO'),
	 ('EDITAR','EVENTO','EVENTO'),
	 ('REMOVER','EVENTO','EVENTO'),
	 ('LER','EVENTO','EVENTO'),
	 ('INSERIR','EVENTOUSUARIO','EVENTOUSUARIO'),
	 ('EDITAR','EVENTOUSUARIO','EVENTOUSUARIO'),
	 ('REMOVER','EVENTOUSUARIO','EVENTOUSUARIO'),
	 ('LER','EVENTOUSUARIO','EVENTOUSUARIO'),
	 ('INSERIR','FORMAPGTO','FORMAPGTO'),
	 ('REMOVER','FORMAPGTO','FORMAPGTO'),
	 ('INSERIR','GRADE','GRADE'),
	 ('EDITAR','GRADE','GRADE'),
	 ('REMOVER','GRADE','GRADE'),
	 ('LER','GRADE','GRADE'),
	 ('INSERIR','JSONTABLE','JSONTABLE'),
	 ('EDITAR','JSONTABLE','JSONTABLE'),
	 ('REMOVER','JSONTABLE','JSONTABLE'),
	 ('LER','JSONTABLE','JSONTABLE'),
	 ('INSERIR','LOGINATTEMPTS','LOGINATTEMPTS'),
	 ('EDITAR','LOGINATTEMPTS','LOGINATTEMPTS'),
	 ('REMOVER','LOGINATTEMPTS','LOGINATTEMPTS'),
	 ('LER','LOGINATTEMPTS','LOGINATTEMPTS'),
	 ('INSERIR','LTREL','LTREL'),
	 ('EDITAR','LTREL','LTREL'),
	 ('REMOVER','LTREL','LTREL'),
	 ('LER','LTREL','LTREL'),
	 ('INSERIR','MENSAGEMGRUPO','MENSAGEMGRUPO'),
	 ('EDITAR','MENSAGEMGRUPO','MENSAGEMGRUPO'),
	 ('REMOVER','MENSAGEMGRUPO','MENSAGEMGRUPO'),
	 ('LER','MENSAGEMGRUPO','MENSAGEMGRUPO'),
	 ('INSERIR','MENSAGEMGRUPOUSERS','MENSAGEMGRUPOUSERS'),
	 ('EDITAR','MENSAGEMGRUPOUSERS','MENSAGEMGRUPOUSERS'),
	 ('REMOVER','MENSAGEMGRUPOUSERS','MENSAGEMGRUPOUSERS'),
	 ('LER','MENSAGEMGRUPOUSERS','MENSAGEMGRUPOUSERS'),
	 ('INSERIR','MUNICIPIO','MUNICIPIO'),
	 ('EDITAR','MUNICIPIO','MUNICIPIO'),
	 ('REMOVER','MUNICIPIO','MUNICIPIO'),
	 ('LER','MUNICIPIO','MUNICIPIO'),
	 ('INSERIR','PAIS','PAIS'),
	 ('EDITAR','FORMAPGTO','FORMAPGTO'),
	 ('REMOVER','APILOG','APILOG'),
	 ('EDITAR','PAIS','PAIS'),
	 ('REMOVER','PAIS','PAIS'),
	 ('LER','PAIS','PAIS'),
	 ...
	 ('LER','PEDIDO','PEDIDO'),
	 ('INSERIR','PEDIDOITEM','PEDIDOITEM'),
	 ('EDITAR','PEDIDOITEM','PEDIDOITEM'),
	 ('REMOVER','PEDIDOITEM','PEDIDOITEM'),
	 ('LER','PEDIDOITEM','PEDIDOITEM'),
	 ('INSERIR','PRICE','PRICE'),
	 ('EDITAR','PRICE','PRICE'),
	 ('REMOVER','PRICE','PRICE'),
	 ('LER','PRICE','PRICE'),
	 ...
	 ('LER','PRODUTO','PRODUTO'),
	 ('INSERIR','PRODUTOTIPO','PRODUTOTIPO'),
	 ('EDITAR','PRODUTOTIPO','PRODUTOTIPO'),
	 ('REMOVER','PRODUTOTIPO','PRODUTOTIPO'),
	 ('LER','PRODUTOTIPO','PRODUTOTIPO'),
	 ('INSERIR','SHARED','SHARED'),
	 ('EDITAR','SHARED','SHARED'),
	 ('REMOVER','SHARED','SHARED'),
	 ('LER','SHARED','SHARED'),
	 ('INSERIR','SISTEMAFUNCAO','SISTEMAFUNCAO'),
	 ('EDITAR','SISTEMAFUNCAO','SISTEMAFUNCAO'),
	 ('REMOVER','SISTEMAFUNCAO','SISTEMAFUNCAO'),
	 ('LER','SISTEMAFUNCAO','SISTEMAFUNCAO'),
	 ('INSERIR','SISTEMALOG','SISTEMALOG'),
	 ('EDITAR','SISTEMALOG','SISTEMALOG'),
	 ('REMOVER','SISTEMALOG','SISTEMALOG'),
	 ('LER','SISTEMALOG','SISTEMALOG'),
	 ('INSERIR','SITE','SITE'),
	 ('EDITAR','SITE','SITE'),
	 ('REMOVER','SITE','SITE'),
	 ('LER','SITE','SITE'),
	 ...
	 ('REMOVER','UF','UF'),
	 ('LER','UF','UF'),
	 ('INSERIR','APILOG','APILOG'),
	 ('INSERIR','USUARIO','USUARIO'),
	 ('EDITAR','USUARIO','USUARIO'),
	 ('REMOVER','USUARIO','USUARIO'),
	 ('LER','USUARIO','USUARIO'),
	 ('INSERIR','WEBHOOK','WEBHOOK'),
	 ('EDITAR','WEBHOOK','WEBHOOK'),
	 ('REMOVER','WEBHOOK','WEBHOOK'),
	 ('LER','WEBHOOK','WEBHOOK'),
	 ('GERENCIAR PERFIS','SISTEMA','USUARIO'),
	 ('LER','SISTEMA','USUARIO'),
	 ('GERENCIAR PERMISSÕES','SISTEMA','USUARIO'),
	 ('LISTAR','PRODUTO','PRODUTO'),
	 ('EDITAR','SISTEMA','USUARIO'),
	 ('LISTAR','UPLOADFILE','UPLOADFILE'),
	 ('EDITAR','STATUS','STATUS'),
	 ('LISTAR','MENSAGEM','MENSAGEM'),
	 ('LER','MENSAGEM','MENSAGEM'),
	 ('EXCLUIR','MENSAGEM','MENSAGEM'),
	 ('EXCLUIR','PRODUTO','PRODUTO'),
	 ('REMOVER','SISTEMA','USUARIO'),
	 ('LER','EVENTO','EVENTOCATEGORIA');

INSERT INTO public.app_status (nome_status,entidade_status,order_status,color_status,extras_status) VALUES
	 ('Em breve','EVENTO',1,NULL,'{"color": "light", "descricao": "Evento cadastro e em breve estará programado"}'),
	 ('Programado','EVENTO',2,NULL,'{"color": "warning", "descricao": "Evento confirmado"}'),
	 ('Ativo','EVENTO',3,'','{"color": "succes", "descricao": "Evento ativo e em processo de venda"}'),
	 ('Inativo','EVENTO',4,'','{"color": "danger", "descricao": "Evento inativo", "depara_pagarme": ""}'),
	 ('Pagamento confirmado','PEDIDO',50,NULL,'{"color": "info", "descricao": "Pagamento confirmado pelo Gateway"}'),
	 ('Checkout do carrinho, aguardando pagamento','PEDIDO',1,NULL,'{"color": "info", "descricao": "Cliente clicou em efetuar pagamento no carrinho de compras"}'),
	 ('Pedido disponivel','PEDIDO',70,NULL,'{"color": "info", "descricao": "Pedido disponível para download"}'),
	 ('Pedido consumido / entregue','PEDIDO',90,NULL,'{"color": "info", "descricao": "Pedido consumido pelo cliente. Download efetuado"}'),
	 ('Convite enviado','EVENTO_USUARIO',1,'info','{"icon": "clock-o"}'),
	 ('Convite aceito','EVENTO_USUARIO',3,'warning','{"icon": "ckeck"}'),
	 ('Convite recusado','EVENTO_USUARIO',2,'danger','{"icon": "ban"}'),
	 ('Ativo','EVENTO_USUARIO',4,'success','{"icon": "check"}'),
	 ('Aguardando recebimento','CAIXA',10,'','{}'),
	 ('Processamento para entrega','PEDIDO',60,NULL,'{"color": "info", "descricao": "Status após efetuado distribuição de comissões. Disponível para empacotamento"}'),
	 ('Pagamento recusado','PEDIDO',11,NULL,'{"color": "info", "descricao": "Pagamento recusado pelo Gateway"}'),
	 ('Cancelado por falta de pagamento','PEDIDO',12,NULL,'{"color": "info", "descricao": "Pagamento não registrado no prazo estabelecido"}'),
	 ('Pagamento estornado','PEDIDO',13,NULL,'{"color": "info", "descricao": "Boleto estornado pelo banco"}'),
	 ('Pagamento cancelado pelo cliente','PEDIDO',14,NULL,'{"color": "info", "descricao": "Pagamento cancelado pelo cliente junto a operadora"}'),
	 ('Disponível','CAIXA',50,NULL,NULL),
	 ('Pagamento recebido / Pedido finalizado','PEDIDO',100,NULL,'{"color": "info", "descricao": "Operadora informou que o valor esta disponível para saque"}'),
	 ('Pagamento em análise pelo gateway','PEDIDO',2,NULL,'{"color": "info", "descricao": "Pagamento já efetuado pelo usuario, mas ainda não concluido pelo gateway"}'),
	 ('Pedido com pacote inscrição','PEDIDO',49,NULL,'{"color": "info", "descricao": "Pagamento recusado pelo Gateway"}'),
	 ('Bloqueado','EVENTO_USUARIO',5,'danger','{"icon": "ban"}');

INSERT INTO public.app_uploadfile (id_uploadfile,createtime_uploadfile,filename_uploadfile,entidade_uploadfile,valorid_uploadfile,nome_uploadfile,descricao_uploadfile,fonte_uploadfile,extensao_uploadfile,mime_uploadfile,classificacao_uploadfile,recognition_id,id_usuario,conteudo_uplodfile,st_fs_uploadfile,atleta_uploadfile) VALUES
	 (10,'2020-01-15 12:01:50.894','2020/01/1086d48bf1b2f9ef87a5842e190451d1.png','UPLOADFILE',1,'Imagem default para não existe','','','png','image/png',2,'',1,'',3,'["0"]'),
	 (100,'2020-03-03 19:15:22.709','2020/03/802ffc816b9520e044ba7946b19e2aea.png','UPLOADFILE',1,'Diners','','','png','image/png',2,'',1,'',3,'["0"]'),
	 (101,'2020-03-03 19:15:07.175','2020/03/d1d709768a805b74f78ecc5bc5b62ac5.jpg','UPLOADFILE',1,'Amex','','','jpg','image/jpeg',2,'',1,'',3,'["0"]'),
	 (102,'2020-03-03 19:12:05.381','2020/03/af35d547dd921572c87f2f8e21b1b918.png','UPLOADFILE',1,'Elo','','','png','image/png',2,'',1,'',3,'["0"]'),
	 (103,'2020-03-03 19:11:27.157','2020/03/4845ec803792a6e25ddfe44e3032cdfd.png','UPLOADFILE',1,'Visa','','','png','image/png',2,'',1,'',3,'["0"]'),
	 (104,'2020-03-03 19:11:13.207','2020/03/30afa43fd20936cea4f871512f0c8320.png','UPLOADFILE',1,'Mastercard','','','png','image/png',2,'',1,'',3,'["0"]'),
	 (105,'2020-03-03 18:59:01.97','2020/03/e3f436d8e7935dc409cdd99d233c7bb1.jpg','UPLOADFILE',1,'BOLETO','','','jpg','image/jpeg',2,'',1,'',3,'["0"]');

INSERT INTO public.caixa_tipo (id_caixa_tipo,nome_caixa_tipo) VALUES
	 (1,'COMISSÃO DE VENDAS'),
	 (3,'COMISSÃO DE ORGANIZADOR'),
	 (4,'COMISSÃO DEV'),
	 (5,'COMISSÃO PLATAFORMA'),
	 (6,'COMISSÃO DE EVENTOS'),
	 (2,'TAXAS DE TRANSAÇÃO');

INSERT INTO public.evento_categoria (id_evento_categoria,nome_evento_categoria,createtime_evento_categoria,extras_evento_categoria) VALUES
	 (9,'Corrida de Rua','2019-04-19 11:29:03.01',NULL),
	 (11,'Outros','2019-04-19 11:29:03.01',NULL),
	 (14,'Triathlon','2019-04-19 11:29:03.01','{"a_definir": "Modelo não definido: extrasEventoCategoria"}'),
	 (13,'Tênis','2019-04-19 11:29:03.01','{"a_definir": "Modelo não definido: extrasEventoCategoria"}'),
	 (12,'Surf','2019-04-19 11:29:03.01','{"config": {"a_definir": {"ro": "false", "tip": "Exibindo o default, pois campo extrasEventoCategoria não foi configurado em /src/config/model_json.php", "grid": "col-sm-4", "type": "text", "class": "", "label": "Modelo não definido"}}, "a_definir": "Modelo não definido: extrasEventoCategoria"}'),
	 (8,'Ciclismo','2019-04-19 11:29:03.01','{"config": {"a_definir": {"id": 0, "ro": "false", "tip": "Exibindo o default, pois campo extrasEventoCategoria não foi configurado em /src/config/model_json.php", "grid": "col-sm-4", "type": "text", "class": "", "label": "Modelo não definido"}}, "a_definir": "Modelo não definido: extrasEventoCategoria"}'),
	 (10,'Corrida de Montanha','2019-04-19 11:29:03.01','{"config": {"a_definir": {"ro": "false", "tip": "Exibindo o default, pois campo extrasEventoCategoria não foi configurado em /src/config/model_json.php", "grid": "col-sm-4", "type": "text", "class": "", "label": "Modelo não definido"}}, "a_definir": "Modelo não definido: extrasEventoCategoria"}');

INSERT INTO public.forma_pgto (id_forma_pgto,nome_forma_pgto,custo_forma_pgto,icone_forma_pgto,ativo_forma_pgto,tp_forma_pgto,mdr_forma_pgto) VALUES
	 (1,'EVENTO FREE',0,10,true,2,NULL),
	 (2,'CREDIT_CARD',0.99,10,true,2,3.79),
	 (4,'PIX',0.55,10,true,2,NULL),
	 (3,'DEBIT_CARD',1.05,10,true,2,NULL),
	 (45,'BOLETO',4.04,105,true,1,NULL);

INSERT INTO public.produto_tipo (id_produto_tipo,nome_produto_tipo) VALUES
	 (1,'Foto Digital'),
	 (2,'Inscrição em eventos'),
	 (50,'Foto impressa'),
	 (51,'Produtos');

INSERT INTO public.produto (id_produto,createtime_produto,nome_produto,id_produto_tipo,ativo_produto,descricao_produto,exigefrete_produto,extras_produto) VALUES
	 (2,'2019-04-19 13:30:59.754','Foto impressa',50,false,'',false,'{"custo": null, "frete": "0,00", "minimo": null, "dimensao": "4500x3000"}'),
	 (3,'2020-02-08 22:20:49.396','Baixa resolução',1,true,'',false,'{"custo": null, "frete": "0,00", "minimo": null, "dimensao": 1800}'),
	 (4,'2020-02-08 22:21:05.647','Média resolução',1,true,'',false,'{"custo": null, "frete": "0,00", "minimo": null, "dimensao": 2700}'),
	 (6,'2020-03-31 20:02:43.476','Midias sociais',1,true,'',false,'{"custo": null, "frete": "0,00", "minimo": null, "dimensao": 1200}'),
	 (1,'2019-04-19 13:30:36.336','Alta resolução',1,true,'Foto digital para download',false,'{"custo": null, "frete": "0,00", "minimo": "15,00", "dimensao": 3600}'),
	 (5,'2020-02-08 22:21:19.582','Plus',1,true,'',false,'{"custo": "", "frete": "0,00", "minimo": "", "dimensao": "4500"}');

-- Resetando todos as sequences para iniciar em 10000
DO $$
DECLARE
i TEXT;
BEGIN
 FOR i IN (SELECT column_default FROM information_schema.columns WHERE column_default SIMILAR TO 'nextval%') 
  LOOP
         EXECUTE 'ALTER SEQUENCE'||' ' || substring(substring(i from '''[a-z_]*')from '[a-z_]+') || ' '||' RESTART WITH 10000;';    
  END LOOP;
END $$; 


TRUNCATE TABLE public.app_usuario_permissao RESTART IDENTITY CASCADE;
insert into app_usuario_permissao (id_usuario, id_sistema_funcao)
select 
	id_usuario, 
	id_sistema_funcao
from app_usuario
left join app_sistema_funcao on true
where id_usuario=1;

update app_usuario set data_senha_usuario = now();


INSERT INTO public.grade (createtime_grade,nome_grade,ativo_grade,id_usuario,prod_grade) VALUES
	('2022-10-08 13:58:52.830257','Produtos 100%',true,1,'[{"id": 1, "nome": "Alta resolução", "ativo": "1", "valor": "14,90", "extras": {"frete": "0,00", "minimo": "15,00", "dimensao": "3600"}}]');
INSERT INTO public.evento (createtime_evento,nome_evento,data_evento,id_municipio,id_evento_categoria,id_status,publico_evento,qtde_fot_evento,regra_fot_evento,senha_evento,id_grade,com_trl_evento,com_org_evento,com_fot_evento,extras_evento,id_usuario,icone_evento,pacote_evento,fts_evento,is_alive_evento) VALUES
	('2022-10-08 13:58:32.521468','MTB Challenge Teste','2022-10-08',4500,8,1,true,100,'','',10000,25,NULL,55,'{"config": {"a_definir": {"id": 0, "ro": "false", "tip": "Exibindo o default, pois campo extrasEvento não foi configurado em /src/config/model_json.php", "grid": "col-sm-4", "type": "text", "class": "", "label": "Modelo não definido"}}, "a_definir": "Modelo não definido: extrasEvento"}',1,NULL,'{"all": {"isAtivo": "S", "vlrPacote": "30,00", "vlrMinFoto": "3,00", "qtdeMinFoto": "10"}, "default": [], "a_definir": "Modelo não definido: pacoteEvento", "inscricao": {"isAtivo": "N", "Uploadfile": {"icon": "file", "error": {"idUsuario": 0, "valoridUploadfile": "Valor do ID da tupla proprietária deste registro", "entidadeUploadfile": "Nome da entidade proprietária deste registro", "filenameUploadfile": "Armazenará o nome do arquivo, com path a partir de PATH/sistema/uploadFiles"}, "perfil": "Público", "thumbs": "view/images/sem-imagem.png", "Usuario": [], "perfilIcon": "globe", "filenameUrl": "view/images/sem-imagem.png", "recognitionId": "", "dateUploadfile": "08/10/2022", "mimeUploadfile": "", "stFsUploadfile": "3", "fonteUploadfile": "", "atletaUploadfile": "[\"0\"]", "conteudoUplodfile": "", "extensaoUploadfile": "", "descricaoUploadfile": "", "createtimeUploadfile": "08/10/2022 13:58:55", "classificacaoUploadfile": "2"}, "idUploadfile": 0}}','''challeng'':2 ''mtb'':1 ''test'':3',true);
INSERT INTO public.pedido (id_pedido, createtime_pedido, id_usuario, id_forma_pgto, extras_pedido, id_status, perc_custo_pgto_pedido, mdr_pedido, custo_proc_pedido) VALUES
	(1, '2022-10-06 19:51:25.152', 1000, 45, '{"mdr": 0, "cost": 4.04, "gateway": "Pagarme", "vlr_bruto": 24.8, "boleto_url": false, "transaction": 18677238, "vlr_liquido": 20.76, "arquivo_data": null, "arquivo_nome": null, "arquivo_download": null}'::jsonb, 8, 16.29, NULL, 4.04);


INSERT INTO auxiliar.bancos (code,name,"document",createdat,updatedat,deletedat,isdeleted) VALUES
	 ('001','BANCO DO BRASIL','00.000.000/0001-91','2017-04-19 15:52:42.400','','','false'),
	 ('341','ITAÚ','','2017-04-19 15:53:59.107','','','false'),
	 ('104','CAIXA ECONÔMICA FEDERAL','','2017-04-19 15:54:41.200','','','false'),
	 ('033','SANTANDER','','2017-04-19 15:55:59.197','','','false'),
	 ('070','BRB - BANCO DE BRASÍLIA','','2017-04-19 15:58:17.387','','','false'),
	 ('077','BANCO INTER','00.416.968/0001-01','2017-04-19 15:58:39.887','2020-04-29 11:08:00.000','','false'),
	 ('237','BRADESCO','','2017-04-19 16:00:31.407','','','false'),
	 ('745','CITIBANK','','2017-04-19 16:01:50.353','','','false'),
	 ('422','BANCO SAFRA','','2017-04-19 16:04:20.790','','','false'),
	 ('399','BANCO HSBC','','2017-04-19 16:05:20.353','','','false'),
	 ('756','BANCOOB','','2017-08-01 22:29:11.827','','','false'),
	 ('212','BANCO ORIGINAL','','2017-10-11 20:33:06.803','','','false'),
	 ('002','BANCO CENTRAL DO BRASIL','','2018-01-29 15:12:24.270','','','false'),
	 ('003','BANCO DA AMAZONIA S.A','','2018-01-29 15:12:24.270','','','false'),
	 ('004','BANCO DO NORDESTE DO BRASIL S.A','','2018-01-29 15:12:24.270','','','false'),
	 ('007','BANCO NAC DESENV. ECO. SOCIAL S.A','','2018-01-29 15:12:24.270','','','false'),
	 ('008','BANCO MERIDIONAL DO BRASIL','','2018-01-29 15:12:24.270','','','false'),
	 ('020','BANCO DO ESTADO DE ALAGOAS S.A','','2018-01-29 15:12:24.270','','','false'),
	 ('021','BANCO DO ESTADO DO ESPIRITO SANTO S.A','','2018-01-29 15:12:24.270','','','false'),
	 ('022','BANCO DE CREDITO REAL DE MINAS GERAIS SA','','2018-01-29 15:12:24.273','','','false'),
	 ('024','BANCO DO ESTADO DE PERNAMBUCO','','2018-01-29 15:12:24.273','','','false'),
	 ('025','BANCO ALFA S/A','','2018-01-29 15:12:24.273','','','false'),
	 ('026','BANCO DO ESTADO DO ACRE S.A','','2018-01-29 15:12:24.273','','','false'),
	 ('027','BANCO DO ESTADO DE SANTA CATARINA S.A','','2018-01-29 15:12:24.273','','','false'),
	 ('028','BANCO DO ESTADO DA BAHIA S.A','','2018-01-29 15:12:24.277','','','false'),
	 ('029','BANCO DO ESTADO DO RIO DE JANEIRO S.A','','2018-01-29 15:12:24.277','','','false'),
	 ('030','BANCO DO ESTADO DA PARAIBA S.A','','2018-01-29 15:12:24.277','','','false'),
	 ('031','BANCO DO ESTADO DE GOIAS S.A','','2018-01-29 15:12:24.277','','','false'),
	 ('032','BANCO DO ESTADO DO MATO GROSSO S.A.','','2018-01-29 15:12:24.277','','','false'),
	 ('034','BANCO DO ESADO DO AMAZONAS S.A','','2018-01-29 15:12:24.280','','','false'),
	 ('035','BANCO DO ESTADO DO CEARA S.A','','2018-01-29 15:12:24.280','','','false'),
	 ('036','BANCO DO ESTADO DO MARANHAO S.A','','2018-01-29 15:12:24.280','','','false'),
	 ('037','BANCO DO ESTADO DO PARA S.A','','2018-01-29 15:12:24.280','','','false'),
	 ('038','BANCO DO ESTADO DO PARANA S.A','','2018-01-29 15:12:24.280','','','false'),
	 ('039','BANCO DO ESTADO DO PIAUI S.A','','2018-01-29 15:12:24.280','','','false'),
	 ('041','BANCO DO ESTADO DO RIO GRANDE DO SUL S.A','','2018-01-29 15:12:24.283','','','false'),
	 ('047','BANCO DO ESTADO DE SERGIPE S.A','','2018-01-29 15:12:24.283','','','false'),
	 ('048','BANCO DO ESTADO DE MINAS GERAIS S.A','','2018-01-29 15:12:24.283','','','false'),
	 ('059','BANCO DO ESTADO DE RONDONIA S.A','','2018-01-29 15:12:24.283','','','false'),
	 ('106','BANCO ITABANCO S.A.','','2018-01-29 15:12:24.287','','','false'),
	 ('107','BANCO BBM S.A','','2018-01-29 15:12:24.287','','','false'),
	 ('109','BANCO CREDIBANCO S.A','','2018-01-29 15:12:24.290','','','false'),
	 ('116','BANCO B.N.L DO BRASIL S.A','','2018-01-29 15:12:24.290','','','false'),
	 ('148','MULTI BANCO S.A','','2018-01-29 15:12:24.290','','','false'),
	 ('151','CAIXA ECONOMICA DO ESTADO DE SAO PAULO','','2018-01-29 15:12:24.290','','','false'),
	 ('153','CAIXA ECONOMICA DO ESTADO DO R.G.SUL','','2018-01-29 15:12:24.290','','','false'),
	 ('165','BANCO NORCHEM S.A','','2018-01-29 15:12:24.290','','','false'),
	 ('166','BANCO INTER-ATLANTICO S.A','','2018-01-29 15:12:24.293','','','false'),
	 ('168','BANCO C.C.F. BRASIL S.A','','2018-01-29 15:12:24.293','','','false'),
	 ('175','CONTINENTAL BANCO S.A','','2018-01-29 15:12:24.293','','','false'),
	 ('184','BBA - CREDITANSTALT S.A','','2018-01-29 15:12:24.293','','','false'),
	 ('197','STONE PAGAMENTOS S.A.','16.501.555/0002-38','2020-04-24 12:58:00.000','','','false'),
	 ('199','BANCO FINANCIAL PORTUGUES','','2018-01-29 15:12:24.293','','','false'),
	 ('200','BANCO FRICRISA AXELRUD S.A','','2018-01-29 15:12:24.297','','','false'),
	 ('201','BANCO AUGUSTA INDUSTRIA E COMERCIAL S.A','','2018-01-29 15:12:24.297','','','false'),
	 ('204','BANCO S.R.L S.A','','2018-01-29 15:12:24.297','','','false'),
	 ('205','BANCO SUL AMERICA S.A','','2018-01-29 15:12:24.297','','','false'),
	 ('206','BANCO MARTINELLI S.A','','2018-01-29 15:12:24.297','','','false'),
	 ('208','BANCO PACTUAL S.A','','2018-01-29 15:12:24.300','','','false'),
	 ('210','DEUTSCH SUDAMERIKANICHE BANK AG','','2018-01-29 15:12:24.300','','','false'),
	 ('211','BANCO SISTEMA S.A','','2018-01-29 15:12:24.300','','','false'),
	 ('213','BANCO ARBI S.A','','2018-01-29 15:12:24.300','','','false'),
	 ('214','BANCO DIBENS S.A','','2018-01-29 15:12:24.303','','','false'),
	 ('215','BANCO AMERICA DO SUL S.A','','2018-01-29 15:12:24.303','','','false'),
	 ('216','BANCO REGIONAL MALCON S.A','','2018-01-29 15:12:24.303','','','false'),
	 ('217','BANCO AGROINVEST S.A','','2018-01-29 15:12:24.303','','','false'),
	 ('218','BS2','71.027.866/0001-34','2018-01-29 15:12:24.303','2019-05-21 08:14:51.000','','false'),
	 ('219','BANCO DE CREDITO DE SAO PAULO S.A','','2018-01-29 15:12:24.307','','','false'),
	 ('220','BANCO CREFISUL','','2018-01-29 15:12:24.307','','','false'),
	 ('221','BANCO GRAPHUS S.A','','2018-01-29 15:12:24.307','','','false'),
	 ('222','BANCO AGF BRASIL S. A.','','2018-01-29 15:12:24.307','','','false'),
	 ('223','BANCO INTERUNION S.A','','2018-01-29 15:12:24.307','','','false'),
	 ('224','BANCO FIBRA S.A','','2018-01-29 15:12:24.307','','','false'),
	 ('225','BANCO BRASCAN S.A','','2018-01-29 15:12:24.310','','','false'),
	 ('228','BANCO ICATU S.A','','2018-01-29 15:12:24.310','','','false'),
	 ('229','BANCO CRUZEIRO S.A','','2018-01-29 15:12:24.310','','','false'),
	 ('230','BANCO BANDEIRANTES S.A','','2018-01-29 15:12:24.310','','','false'),
	 ('231','BANCO BOAVISTA S.A','','2018-01-29 15:12:24.310','','','false'),
	 ('232','BANCO INTERPART S.A','','2018-01-29 15:12:24.310','','','false'),
	 ('233','BANCO MAPPIN S.A','','2018-01-29 15:12:24.313','','','false'),
	 ('234','BANCO LAVRA S.A.','','2018-01-29 15:12:24.313','','','false'),
	 ('235','BANCO LIBERAL S.A','','2018-01-29 15:12:24.313','','','false'),
	 ('236','BANCO CAMBIAL S.A','','2018-01-29 15:12:24.313','','','false'),
	 ('239','BANCO BANCRED S.A','','2018-01-29 15:12:24.317','','','false'),
	 ('240','BANCO DE CREDITO REAL DE MINAS GERAIS S.','','2018-01-29 15:12:24.317','','','false'),
	 ('241','BANCO CLASSICO S.A','','2018-01-29 15:12:24.317','','','false'),
	 ('242','BANCO EUROINVEST S.A','','2018-01-29 15:12:24.317','','','false'),
	 ('243','BANCO MÁXIMA S.A','33.923.798/0001-00','2018-01-29 15:12:24.317','2020-03-20 17:00:00.000','','false'),
	 ('244','BANCO CIDADE S.A','','2018-01-29 15:12:24.320','','','false'),
	 ('245','BANCO EMPRESARIAL S.A','','2018-01-29 15:12:24.320','','','false'),
	 ('246','BANCO ABC ROMA S.A','','2018-01-29 15:12:24.320','','','false'),
	 ('247','BANCO OMEGA S.A','','2018-01-29 15:12:24.320','','','false'),
	 ('249','BANCO INVESTCRED S.A','','2018-01-29 15:12:24.320','','','false'),
	 ('250','BANCO SCHAHIN CURY S.A','','2018-01-29 15:12:24.320','','','false'),
	 ('251','BANCO SAO JORGE S.A.','','2018-01-29 15:12:24.323','','','false'),
	 ('252','BANCO FININVEST S.A','','2018-01-29 15:12:24.323','','','false'),
	 ('254','BANCO PARANA BANCO S.A','','2018-01-29 15:12:24.323','','','false'),
	 ('255','MILBANCO S.A.','','2018-01-29 15:12:24.323','','','false'),
	 ('256','BANCO GULVINVEST S.A','','2018-01-29 15:12:24.323','','','false'),
	 ('258','BANCO INDUSCRED S.A','','2018-01-29 15:12:24.327','','','false'),
	 ('261','BANCO VARIG S.A','','2018-01-29 15:12:24.327','','','false'),
	 ('262','BANCO BOREAL S.A','','2018-01-29 15:12:24.327','','','false'),
	 ('263','BANCO CACIQUE','','2018-01-29 15:12:24.327','','','false'),
	 ('264','BANCO PERFORMANCE S.A','','2018-01-29 15:12:24.330','','','false'),
	 ('265','BANCO FATOR S.A','','2018-01-29 15:12:24.330','','','false'),
	 ('266','BANCO CEDULA S.A','','2018-01-29 15:12:24.330','','','false'),
	 ('267','BANCO BBM-COM.C.IMOB.CFI S.A.','','2018-01-29 15:12:24.330','','','false'),
	 ('275','BANCO REAL S.A','','2018-01-29 15:12:24.330','','','false'),
	 ('277','BANCO PLANIBANC S.A','','2018-01-29 15:12:24.330','','','false'),
	 ('282','BANCO BRASILEIRO COMERCIAL','','2018-01-29 15:12:24.330','','','false'),
	 ('291','BANCO DE CREDITO NACIONAL S.A','','2018-01-29 15:12:24.333','','','false'),
	 ('294','BCR - BANCO DE CREDITO REAL S.A','','2018-01-29 15:12:24.333','','','false'),
	 ('295','BANCO CREDIPLAN S.A','','2018-01-29 15:12:24.333','','','false'),
	 ('300','BANCO DE LA NACION ARGENTINA S.A','','2018-01-29 15:12:24.333','','','false'),
	 ('302','BANCO DO PROGRESSO S.A','','2018-01-29 15:12:24.337','','','false'),
	 ('303','BANCO HNF S.A.','','2018-01-29 15:12:24.337','','','false'),
	 ('304','BANCO PONTUAL S.A','','2018-01-29 15:12:24.337','','','false'),
	 ('308','BANCO COMERCIAL BANCESA S.A.','','2018-01-29 15:12:24.337','','','false'),
	 ('318','BANCO B.M.G. S.A','','2018-01-29 15:12:24.337','','','false'),
	 ('320','BANCO INDUSTRIAL E COMERCIAL','','2018-01-29 15:12:24.340','','','false'),
	 ('346','BANCO FRANCES E BRASILEIRO S.A','','2018-01-29 15:12:24.340','','','false'),
	 ('347','BANCO SUDAMERIS BRASIL S.A','','2018-01-29 15:12:24.340','','','false'),
	 ('351','BANCO BOZANO SIMONSEN S.A','','2018-01-29 15:12:24.340','','','false'),
	 ('353','BANCO GERAL DO COMERCIO S.A','','2018-01-29 15:12:24.340','','','false'),
	 ('356','ABN AMRO S.A','','2018-01-29 15:12:24.340','','','false'),
	 ('366','BANCO SOGERAL S.A','','2018-01-29 15:12:24.343','','','false'),
	 ('369','PONTUAL','','2018-01-29 15:12:24.343','','','false'),
	 ('370','BEAL - BANCO EUROPEU PARA AMERICA LATINA','','2018-01-29 15:12:24.343','','','false'),
	 ('372','BANCO ITAMARATI S.A','','2018-01-29 15:12:24.347','','','false'),
	 ('375','BANCO FENICIA S.A','','2018-01-29 15:12:24.347','','','false'),
	 ('376','CHASE MANHATTAN BANK S.A','','2018-01-29 15:12:24.347','','','false'),
	 ('388','BANCO MERCANTIL DE DESCONTOS S/A','','2018-01-29 15:12:24.347','','','false'),
	 ('389','BANCO MERCANTIL DO BRASIL S.A','','2018-01-29 15:12:24.347','','','false'),
	 ('392','BANCO MERCANTIL DE SAO PAULO S.A','','2018-01-29 15:12:24.350','','','false'),
	 ('394','BANCO B.M.C. S.A','','2018-01-29 15:12:24.350','','','false'),
	 ('409','UNIBANCO - UNIAO DOS BANCOS BRASILEIROS','','2018-01-29 15:12:24.350','','','false'),
	 ('412','BANCO NACIONAL DA BAHIA S.A','','2018-01-29 15:12:24.350','','','false'),
	 ('415','BANCO NACIONAL S.A','','2018-01-29 15:12:24.350','','','false'),
	 ('420','BANCO NACIONAL DO NORTE S.A','','2018-01-29 15:12:24.350','','','false'),
	 ('424','BANCO NOROESTE S.A','','2018-01-29 15:12:24.353','','','false'),
	 ('434','BANCO FORTALEZA S.A','','2018-01-29 15:12:24.353','','','false'),
	 ('453','BANCO RURAL S.A','','2018-01-29 15:12:24.353','','','false'),
	 ('456','BANCO TOKIO S.A','','2018-01-29 15:12:24.353','','','false'),
	 ('464','BANCO SUMITOMO BRASILEIRO S.A','','2018-01-29 15:12:24.357','','','false'),
	 ('466','BANCO MITSUBISHI BRASILEIRO S.A','','2018-01-29 15:12:24.357','','','false'),
	 ('472','LLOYDS BANK PLC','','2018-01-29 15:12:24.357','','','false'),
	 ('473','BANCO FINANCIAL PORTUGUES S.A','','2018-01-29 15:12:24.357','','','false'),
	 ('477','CITIBANK N.A','','2018-01-29 15:12:24.357','','','false'),
	 ('479','BANCO DE BOSTON S.A','','2018-01-29 15:12:24.360','','','false'),
	 ('480','BANCO PORTUGUES DO ATLANTICO-BRASIL S.A','','2018-01-29 15:12:24.360','','','false'),
	 ('483','BANCO AGRIMISA S.A.','','2018-01-29 15:12:24.360','','','false'),
	 ('487','DEUTSCHE BANK S.A - BANCO ALEMAO','','2018-01-29 15:12:24.360','','','false'),
	 ('488','BANCO J. P. MORGAN S.A','','2018-01-29 15:12:24.360','','','false'),
	 ('489','BANESTO BANCO URUGAUAY S.A','','2018-01-29 15:12:24.360','','','false'),
	 ('492','INTERNATIONALE NEDERLANDEN BANK N.V.','','2018-01-29 15:12:24.363','','','false'),
	 ('493','BANCO UNION S.A.C.A','','2018-01-29 15:12:24.363','','','false'),
	 ('494','BANCO LA REP. ORIENTAL DEL URUGUAY','','2018-01-29 15:12:24.363','','','false'),
	 ('495','BANCO LA PROVINCIA DE BUENOS AIRES','','2018-01-29 15:12:24.363','','','false'),
	 ('496','BANCO EXTERIOR DE ESPANA S.A','','2018-01-29 15:12:24.363','','','false'),
	 ('498','CENTRO HISPANO BANCO','','2018-01-29 15:12:24.367','','','false'),
	 ('499','BANCO IOCHPE S.A','','2018-01-29 15:12:24.367','','','false'),
	 ('501','BANCO BRASILEIRO IRAQUIANO S.A.','','2018-01-29 15:12:24.367','','','false'),
	 ('502','BANCO SANTANDER DE NEGOCIOS S.A','','2018-01-29 15:12:24.367','2020-06-18 23:37:00.000','','false'),
	 ('504','BANCO MULTIPLIC S.A','','2018-01-29 15:12:24.367','','','false'),
	 ('505','BANCO GARANTIA S.A','','2018-01-29 15:12:24.370','','','false'),
	 ('600','BANCO LUSO BRASILEIRO S.A','','2018-01-29 15:12:24.370','','','false'),
	 ('601','BFC BANCO S.A.','','2018-01-29 15:12:24.370','','','false'),
	 ('602','BANCO PATENTE S.A','','2018-01-29 15:12:24.370','','','false'),
	 ('604','BANCO INDUSTRIAL DO BRASIL S.A','','2018-01-29 15:12:24.370','','','false'),
	 ('607','BANCO SANTOS NEVES S.A','','2018-01-29 15:12:24.373','','','false'),
	 ('608','BANCO OPEN S.A','','2018-01-29 15:12:24.373','','','false'),
	 ('610','BANCO V.R. S.A','','2018-01-29 15:12:24.373','','','false'),
	 ('611','BANCO PAULISTA S.A','','2018-01-29 15:12:24.373','','','false'),
	 ('612','BANCO GUANABARA S.A','','2018-01-29 15:12:24.377','','','false'),
	 ('613','BANCO PECUNIA S.A','','2018-01-29 15:12:24.377','','','false'),
	 ('616','BANCO INTERPACIFICO S.A','','2018-01-29 15:12:24.377','','','false'),
	 ('617','BANCO INVESTOR S.A.','','2018-01-29 15:12:24.377','','','false'),
	 ('618','BANCO TENDENCIA S.A','','2018-01-29 15:12:24.377','','','false'),
	 ('621','BANCO APLICAP S.A.','','2018-01-29 15:12:24.380','','','false'),
	 ('622','BANCO DRACMA S.A','','2018-01-29 15:12:24.380','','','false'),
	 ('623','BANCO PANAMERICANO S.A','','2018-01-29 15:12:24.380','','','false'),
	 ('624','BANCO GENERAL MOTORS S.A','','2018-01-29 15:12:24.380','','','false'),
	 ('625','BANCO ARAUCARIA S.A','','2018-01-29 15:12:24.380','','','false'),
	 ('626','BANCO FICSA S.A','','2018-01-29 15:12:24.380','','','false'),
	 ('627','BANCO DESTAK S.A','','2018-01-29 15:12:24.383','','','false'),
	 ('628','BANCO CRITERIUM S.A','','2018-01-29 15:12:24.383','','','false'),
	 ('629','BANCORP BANCO COML. E. DE INVESTMENTO','','2018-01-29 15:12:24.383','','','false'),
	 ('630','BANCO INTERCAP S.A','','2018-01-29 15:12:24.383','','','false'),
	 ('633','BANCO REDIMENTO S.A','','2018-01-29 15:12:24.383','','','false'),
	 ('634','BANCO TRIANGULO S.A','','2018-01-29 15:12:24.387','','','false'),
	 ('635','BANCO DO ESTADO DO AMAPA S.A','','2018-01-29 15:12:24.387','','','false'),
	 ('637','BANCO SOFISA S.A','','2018-01-29 15:12:24.387','','','false'),
	 ('638','BANCO PROSPER S.A','','2018-01-29 15:12:24.387','','','false'),
	 ('639','BIG S.A. - BANCO IRMAOS GUIMARAES','','2018-01-29 15:12:24.387','','','false'),
	 ('640','BANCO DE CREDITO METROPOLITANO S.A','','2018-01-29 15:12:24.390','','','false'),
	 ('641','BANCO EXCEL ECONOMICO S/A','','2018-01-29 15:12:24.390','','','false'),
	 ('643','BANCO SEGMENTO S.A','','2018-01-29 15:12:24.390','','','false'),
	 ('645','BANCO DO ESTADO DE RORAIMA S.A','','2018-01-29 15:12:24.390','','','false'),
	 ('647','BANCO MARKA S.A','','2018-01-29 15:12:24.390','','','false'),
	 ('648','BANCO ATLANTIS S.A','','2018-01-29 15:12:24.390','','','false'),
	 ('649','BANCO DIMENSAO S.A','','2018-01-29 15:12:24.390','','','false'),
	 ('650','BANCO PEBB S.A','','2018-01-29 15:12:24.393','','','false'),
	 ('652','BANCO FRANCES E BRASILEIRO SA','','2018-01-29 15:12:24.393','','','false'),
	 ('653','BANCO INDUSVAL S.A','','2018-01-29 15:12:24.393','','','false'),
	 ('654','BANCO A. J. RENNER S.A','','2018-01-29 15:12:24.393','','','false'),
	 ('655','BANCO VOTORANTIM S.A.','','2018-01-29 15:12:24.393','','','false'),
	 ('656','BANCO MATRIX S.A','','2018-01-29 15:12:24.397','','','false'),
	 ('657','BANCO TECNICORP S.A','','2018-01-29 15:12:24.397','','','false'),
	 ('658','BANCO PORTO REAL S.A','','2018-01-29 15:12:24.397','','','false'),
	 ('702','BANCO SANTOS S.A','','2018-01-29 15:12:24.397','','','false'),
	 ('705','BANCO INVESTCORP S.A.','','2018-01-29 15:12:24.400','','','false'),
	 ('707','BANCO DAYCOVAL S.A','','2018-01-29 15:12:24.400','','','false'),
	 ('711','BANCO VETOR S.A.','','2018-01-29 15:12:24.400','','','false'),
	 ('713','BANCO CINDAM S.A','','2018-01-29 15:12:24.400','','','false'),
	 ('715','BANCO VEGA S.A','','2018-01-29 15:12:24.400','','','false'),
	 ('718','BANCO OPERADOR S.A','','2018-01-29 15:12:24.400','','','false'),
	 ('719','BANCO PRIMUS S.A','','2018-01-29 15:12:24.400','','','false'),
	 ('720','BANCO MAXINVEST S.A','','2018-01-29 15:12:24.403','','','false'),
	 ('721','BANCO CREDIBEL S.A','','2018-01-29 15:12:24.403','','','false'),
	 ('722','BANCO INTERIOR DE SAO PAULO S.A','','2018-01-29 15:12:24.403','','','false'),
	 ('724','BANCO PORTO SEGURO S.A','','2018-01-29 15:12:24.403','','','false'),
	 ('725','BANCO FINABANCO S.A','','2018-01-29 15:12:24.407','','','false'),
	 ('726','BANCO UNIVERSAL S.A','','2018-01-29 15:12:24.407','','','false'),
	 ('728','BANCO FITAL S.A','','2018-01-29 15:12:24.407','','','false'),
	 ('729','BANCO FONTE S.A','','2018-01-29 15:12:24.407','','','false'),
	 ('730','BANCO COMERCIAL PARAGUAYO S.A','','2018-01-29 15:12:24.407','','','false'),
	 ('731','BANCO GNPP S.A.','','2018-01-29 15:12:24.410','','','false'),
	 ('732','BANCO PREMIER S.A.','','2018-01-29 15:12:24.410','','','false'),
	 ('733','BANCO NACOES S.A.','','2018-01-29 15:12:24.410','','','false'),
	 ('734','BANCO GERDAU S.A','','2018-01-29 15:12:24.410','','','false'),
	 ('735','BANCO NEON','','2018-01-29 15:12:24.410','2019-11-12 19:15:00.000','2019-11-12 19:15:00.000','true'),
	 ('736','BANCO UNITED S.A','','2018-01-29 15:12:24.410','','','false'),
	 ('737','THECA','','2018-01-29 15:12:24.413','','','false'),
	 ('738','MARADA','','2018-01-29 15:12:24.413','','','false'),
	 ('739','BGN','','2018-01-29 15:12:24.413','','','false'),
	 ('740','BCN BARCLAYS','','2018-01-29 15:12:24.413','','','false'),
	 ('741','BRP','','2018-01-29 15:12:24.413','','','false'),
	 ('742','EQUATORIAL','','2018-01-29 15:12:24.417','','','false'),
	 ('743','BANCO EMBLEMA S.A','','2018-01-29 15:12:24.417','','','false'),
	 ('744','THE FIRST NATIONAL BANK OF BOSTON','','2018-01-29 15:12:24.417','','','false'),
	 ('746','MODAL SA','','2018-01-29 15:12:24.417','','','false'),
	 ('747','RABOBANK DO BRASIL','01.023.570/0001-60','2018-01-29 15:12:24.420','2020-04-23 22:00:00.000','','false'),
	 ('748','SICREDI','','2018-01-29 15:12:24.420','','','false'),
	 ('749','BRMSANTIL SA','','2018-01-29 15:12:24.420','','','false'),
	 ('750','BANCO REPUBLIC NATIONAL OF NEW YORK (BRA','','2018-01-29 15:12:24.420','','','false'),
	 ('751','DRESDNER BANK LATEINAMERIKA-BRASIL S/A','','2018-01-29 15:12:24.420','','','false'),
	 ('752','BANCO BANQUE NATIONALE DE PARIS BRASIL S','','2018-01-29 15:12:24.420','','','false'),
	 ('753','BANCO COMERCIAL URUGUAI S.A.','','2018-01-29 15:12:24.423','','','false'),
	 ('755','BANCO MERRILL LYNCH S.A','','2018-01-29 15:12:24.423','','','false'),
	 ('757','BANCO KEB DO BRASIL S.A.','','2018-01-29 15:12:24.423','','','false'),
	 ('260','Nu Pagamentos S.A','18.236.120/0001-58','2018-01-29 16:47:35.153','','','false'),
	 ('102','XP INVESTIMENTOS','','2018-01-29 16:47:35.210','','','false'),
	 ('336','BANCO C6 S.A.','31.872.495/0001-72','2019-08-02 13:11:00.000','','','false'),
	 ('290','PagSeguro Internet S.A.','08.561.701/0001-01','2019-08-21 12:47:00.000','','','false'),
	 ('323','MercadoPago.com Representações Ltda.','10.573.521/0001-91','2019-09-13 15:23:00.000','','','false'),
	 ('332','Acesso Soluções de Pagamento S.A.','13.140.088/0001-99','2019-12-26 15:00:00.000','','','false'),
	 ('325','Órama DTVM S.A.','13.293.225/0001-25','2020-01-15 19:27:00.000','','','false'),
	 ('085','COOPERATIVA CENTRAL DE CREDITO - AILOS','05.463.212/0001-29','2020-03-20 18:04:00.000','','','false'),
	 ('125','PLURAL S.A. BANCO MULTIPLO','45.246.410/0001-55','2020-03-20 18:13:00.000','','','false');
